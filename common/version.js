...
var HELPER_PKG = {
  ...
  pkg:    'v1.11.5',                      // 下載包（zip）版本 ＝ 檔名
  exe:    '1.11.5',                       // exe 內的 I2C_BRIDGE_VERSION（ping 回報值）
  proto:  3,                             // wire protocol 版本（3 起有 lock：量測中拒絕接手）
  file:   'data/i2c-bridge-v1.11.5.zip',
  bytes:  353089,                             // zip 位元組數（打包後填）
  zipSha: '7be50d6423a9b60d525101a8ce08d8f02023036f4c87250a211fdf18477fce87',
  exeSha: 'd602762e6d0c6deb9b0aa46f76ac8aececfdf3f8da91182e1af2cf81c19c906a'
};
