...
var I18N = {
  ...
  'wfg.ackChecked':     { 'zh-TW': '我已確認', 'en': 'Confirmed', 'zh-CN': '我已确认' },
  'wfg.ackHint':        { 'zh-TW': '兩項都勾選後才能關閉', 'en': 'Tick both to close',
                          'zh-CN': '两项都勾选后才能关闭' },
  'wfg.ackHintOk':      { 'zh-TW': '兩項都已確認，可以開始編輯', 'en': 'Both confirmed - you can start editing',
                          'zh-CN': '两项都已确认，可以开始编辑' },
