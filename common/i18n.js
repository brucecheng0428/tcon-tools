...
var I18N = {
  ...
  'wfg.codeNotSupported': { 'zh-TW': '{m} 尚未支援，目前只實作 EM02。',
                            'en': '{m} is not supported yet; only EM02 is implemented.',
                            'zh-CN': '{m} 尚未支持，目前只实作 EM02。' },
  ...
  'wfg.ackDclkName':    { 'zh-TW': 'TCON DCLK 必須手動設定', 'en': 'TCON DCLK must be set by hand',
                          'zh-CN': 'TCON DCLK 必须手动设定' },
  'wfg.ackDclkWhere':   { 'zh-TW': '位置：左側「Frame 參數」卡片 → TCON DCLK',
                          'en': 'Where: the Frame parameters card on the left → TCON DCLK',
                          'zh-CN': '位置：左侧「Frame 参数」卡片 → TCON DCLK' },
  'wfg.ackLbName':      { 'zh-TW': 'TCON 內部 Line Buffer 必須手動設定',
                          'en': 'TCON internal Line Buffer must be set by hand',
                          'zh-CN': 'TCON 内部 Line Buffer 必须手动设定' },
  'wfg.ackLbWhere':     { 'zh-TW': '位置：上方工具列「TCON」group → Line Buffer',
                          'en': 'Where: the TCON group in the toolbar above → Line Buffer',
                          'zh-CN': '位置：上方工具栏「TCON」group → Line Buffer' },
  'wfg.ackNow':         { 'zh-TW': '目前值：{v}', 'en': 'Current: {v}', 'zh-CN': '目前值：{v}' },
  'wfg.ackGoto':        { 'zh-TW': '帶我去 →', 'en': 'Take me there →', 'zh-CN': '带我去 →' },
  'wfg.spotBack':       { 'zh-TW': '回到設定 ←', 'en': '← Back to the dialog', 'zh-CN': '回到设定 ←' },
  'wfg.spotDclk':       { 'zh-TW': '這裡就是 TCON DCLK，看完按右邊回到設定',
                          'en': 'This is TCON DCLK - use the button to go back',
                          'zh-CN': '这里就是 TCON DCLK，看完按右边回到设定' },
  'wfg.spotLb':         { 'zh-TW': '這裡就是 Line Buffer，看完按右邊回到設定',
                          'en': 'This is Line Buffer - use the button to go back',
                          'zh-CN': '这里就是 Line Buffer，看完按右边回到设定' },
  ...
  'wfg.ackErrDclkMin':  { 'zh-TW': 'TCON DCLK 不可低於 RX DCLK（{v} MHz）',
                          'en': 'TCON DCLK cannot be lower than RX DCLK ({v} MHz)',
                          'zh-CN': 'TCON DCLK 不可低于 RX DCLK（{v} MHz）' },
  'wfg.ackErrLb':       { 'zh-TW': 'Line Buffer 必須是 0~15 的整數',
                          'en': 'Line Buffer must be an integer from 0 to 15',
                          'zh-CN': 'Line Buffer 必须是 0~15 的整数' },
  'wfg.ackDclkVarMode': { 'zh-TW': '變頻應用：TCON DCLK 自動等於 RX DCLK，不需手動設定',
                          'en': 'Variable-rate mode: TCON DCLK follows RX DCLK automatically - nothing to set',
                          'zh-CN': '变频应用：TCON DCLK 自动等于 RX DCLK，不需手动设定' },
