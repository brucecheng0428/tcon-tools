...
var I18N = {
  ...
  'wfg.laGuideStep1':   { 'zh-TW': '若還沒有裝置支援包「la-device-support-pack-v4.zip」，請聯絡 Bruce 協助提供（此包支援全系列機型：M16-100／M16S-100／M16-200（含新 Type-C 版 A2 修訂）／M16-500／M32-500）。', 'en': 'If you do not have the device support pack "la-device-support-pack-v4.zip" yet, please contact Bruce for assistance (it covers the whole series: M16-100 / M16S-100 / M16-200 incl. the new Type-C A2 revision / M16-500 / M32-500).', 'zh-CN': '若还没有设备支持包「la-device-support-pack-v4.zip」，请联络 Bruce 协助提供（此包支持全系列机型：M16-100／M16S-100／M16-200（含新 Type-C 版 A2 修订）／M16-500／M32-500）。' },
  ...
  'wfg.laLegacyPackageWarn': { 'zh-TW': '注意：此為第一代舊版檔案包，僅含單顆 M16-200-A1 bitstream。舊版 16通道200MHz 機型仍可正常使用；其他機型（含新 Type-C 版 A2 修訂）請改匯入新版「la-device-support-pack-v4.zip」。', 'en': 'Note: this is the first-generation legacy package with only the M16-200-A1 bitstream. The old 16ch/200MHz model still works; for any other model (incl. the new Type-C A2 revision), please import the new "la-device-support-pack-v4.zip" instead.', 'zh-CN': '注意：此为第一代旧版文件包，仅含单颗 M16-200-A1 bitstream。旧版 16通道200MHz 机型仍可正常使用；其他机型（含新 Type-C 版 A2 修订）请改导入新版「la-device-support-pack-v4.zip」。' },
  'wfg.laV2PackageWarn': { 'zh-TW': '注意：此為 v2 檔案包，僅含 M16-200／M16-100 系列 bitstream。這兩系列仍可正常使用；若要支援全系列機型（M16S-100／M16-500／M32-500），請改匯入新版「la-device-support-pack-v4.zip」。', 'en': 'Note: this is the v2 package with M16-200/M16-100 bitstreams only. Those still work; for the whole series (M16S-100/M16-500/M32-500), please import the new "la-device-support-pack-v4.zip" instead.', 'zh-CN': '注意：此为 v2 文件包，仅含 M16-200／M16-100 系列 bitstream。这两系列仍可正常使用；若要支持全系列机型（M16S-100／M16-500／M32-500），请改导入新版「la-device-support-pack-v4.zip」。' },
  'wfg.laV3PackageWarn': { 'zh-TW': '注意：此為 v3 檔案包（舊檔名）。內容與 v4 相同、仍可正常使用；建議改用新版「la-device-support-pack-v4.zip」（全中性檔名）。', 'en': 'Note: this is the v3 package (legacy file names). Its contents match v4 and it still works; the new "la-device-support-pack-v4.zip" (neutral file names) is recommended.', 'zh-CN': '注意：此为 v3 文件包（旧文件名）。内容与 v4 相同、仍可正常使用；建议改用新版「la-device-support-pack-v4.zip」（全中性文件名）。' },
