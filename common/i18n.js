...
var I18N = {
  ...
  /* v2.97.471: 檔案包改版為 kingst-la-firmware-allseries-v3.zip（KingstVIS 全系列：MCU fw 依 USB PID、bitstream 依 EEPROM magic 自動選檔） */
  'wfg.laGuideStep1':   { 'zh-TW': '若還沒有檔案包「kingst-la-firmware-allseries-v3.zip」，請聯絡 Bruce 協助提供（此包支援 KingstVIS 全系列：LA1010／LA1016／LA2016（含新 Type-C 版）／LA5016／LA5032）。', 'en': 'If you do not have the package "kingst-la-firmware-allseries-v3.zip" yet, please contact Bruce for assistance (it covers the whole KingstVIS series: LA1010 / LA1016 / LA2016 incl. the new Type-C revision / LA5016 / LA5032).', 'zh-CN': '若还没有文件包「kingst-la-firmware-allseries-v3.zip」，请联络 Bruce 协助提供（此包支持 KingstVIS 全系列：LA1010／LA1016／LA2016（含新 Type-C 版）／LA5016／LA5032）。' },
  ...
  'wfg.laContactBody': { 'zh-TW': '如需要 WebUSB 韌體檔案包「kingst-la-firmware-allseries-v3.zip」，請聯絡 Bruce 協助提供。取得檔案後，回到上一個視窗按「匯入 zip 檔案包」即可完成設定。', 'en': 'To obtain the WebUSB firmware package "kingst-la-firmware-allseries-v3.zip", please contact Bruce for assistance. Once you have the file, return to the previous dialog and click “Import zip Package” to finish setup.', 'zh-CN': '如需要 WebUSB 固件文件包「kingst-la-firmware-allseries-v3.zip」，请联络 Bruce 协助提供。取得文件后，回到上一个视窗按「导入 zip 文件包」即可完成设定。' },
  'wfg.laContactClose': { 'zh-TW': '我知道了', 'en': 'Got it', 'zh-CN': '我知道了' },
  /* v2.97.471: 匯入舊版包時的辨識提示（v1 單 blob 舊包／v2 multipack 舊包，各自指名 v3 新檔名） */
  'wfg.laLegacyPackageWarn': { 'zh-TW': '注意：此為第一代舊版檔案包，僅含單顆 la2016a1 bitstream。舊版 LA2016 仍可正常使用；其他機型（含新 Type-C 版 LA2016）請改匯入新版「kingst-la-firmware-allseries-v3.zip」。', 'en': 'Note: this is the first-generation legacy package with only the la2016a1 bitstream. The old LA2016 still works; for any other model (incl. the new Type-C LA2016), please import the new "kingst-la-firmware-allseries-v3.zip" instead.', 'zh-CN': '注意：此为第一代旧版文件包，仅含单颗 la2016a1 bitstream。旧版 LA2016 仍可正常使用；其他机型（含新 Type-C 版 LA2016）请改导入新版「kingst-la-firmware-allseries-v3.zip」。' },
  'wfg.laV2PackageWarn': { 'zh-TW': '注意：此為 v2 檔案包，僅含 LA2016／LA1016 系列 bitstream。LA2016／LA1016 仍可正常使用；若要支援 KingstVIS 全系列（LA1010／LA5016／LA5032），請改匯入新版「kingst-la-firmware-allseries-v3.zip」。', 'en': 'Note: this is the v2 package with LA2016/LA1016 bitstreams only. LA2016/LA1016 still work; for the whole KingstVIS series (LA1010/LA5016/LA5032), please import the new "kingst-la-firmware-allseries-v3.zip" instead.', 'zh-CN': '注意：此为 v2 文件包，仅含 LA2016／LA1016 系列 bitstream。LA2016／LA1016 仍可正常使用；若要支持 KingstVIS 全系列（LA1010／LA5016／LA5032），请改导入新版「kingst-la-firmware-allseries-v3.zip」。' },
