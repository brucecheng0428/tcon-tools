...
var I18N = {
  ...
  'wfg.codeChunkOff':   { 'zh-TW': '偵測到未下載的區塊', 'en': 'chunks detected as not downloaded',
                          'zh-CN': '侦测到未下载的区块' },
  'wfg.codeScriptHdr':  { 'zh-TW': '匯出的 EM02 GPO 設定（Script 分頁可直接 Load）',
                          'en': 'exported EM02 GPO settings (loadable from the Script tab)',
                          'zh-CN': '导出的 EM02 GPO 设定（Script 分页可直接 Load）' },
  ...
  'wfg.codeScriptNote': { 'zh-TW': '本檔只寫數位信號（GPO），不含 Frame timing 與類比設定',
                          'en': 'this file only writes the digital signals (GPO); no frame timing or analog settings',
                          'zh-CN': '本档只写数字信号（GPO），不含 Frame timing 与模拟设定' },
