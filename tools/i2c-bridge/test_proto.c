...
int main(void){
       ...
       向量：slave 0x50、addr 0x1234、awid 2、讀 4 byte、**ckDelay=3**。 */
    {
        static const char* EXPECT =
            "";
        ...
        CHECK(strstr(hex, "8E00")   != NULL, "🔴 NACK ＝ 放開 ＋ 0x8E 補一個時脈");
       ...
       整段資料就會偏移 —— 這是最可能的一種錯法，所以這裡直接解析命令流來確認。 */
    {
        ...
        /* 🔴 開汲極之後：前 7 個 byte 用 `0x13` 主動拉低發 ACK，
           **最後一個 byte 的 NACK 改成「維持放開 ＋ `0x8E` 補一個時脈」** ——
           NACK ＝ 讓 SDA 維持高 ＝ 不要驅動它，不是用 0x13 輸出 0xFF 去推高。 */
        EQ_INT(nAck13, 7, "前 7 個資料 byte 用 0x13 拉低發 ACK");
        EQ_INT(bad13, 0, "這 7 個 ACK 都是 0x00");
        EQ_INT(lastAckVal, 0x00, "最後一個 0x13 是第 7 個 byte 的 ACK（0x00）");
        EQ_INT(nClk8E, 1, "🔴 最後一個 byte 的 NACK ＝ 放開 ＋ 剛好一個 0x8E 時脈");
