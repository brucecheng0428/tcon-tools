...
> 🔴 **本檔 §4「裁定」表已於同日失效。** Bruce 於 2026-09-10 提供了 §5 清單中第一順位來源（Linux kernel `include/drm/display/drm_dp.h`）的原文，6 個位址已全部裁定完成，見 **`docs/dpcd_edp_conflict_resolution_20260910.md`**。本檔其餘章節（§1 背景、§2 兩邊現況、§3 本機依據盤點、§6 `00700h` 附記）仍然有效。
